...
class DualScopeValidationAspect {
  ...
  fun validateRequireServiceScope(
    joinPoint: JoinPoint,
    requireServiceScope: RequireServiceScope,
  ) {
    val callContext =
      UnifiedContext.getCurrentContext()
  ...
  fun validateAllowBothCallTypes(
    joinPoint: JoinPoint,
    allowBothCallTypes: AllowBothCallTypes,
  ) {
    val callContext =
      UnifiedContext.getCurrentContext()
        ?: throw AccessDeniedException("No call context available")
  ...
  fun validateClassRequireServiceScope(
    joinPoint: JoinPoint,
    requireServiceScope: RequireServiceScope,
  ) {
  ...
  fun validateClassAllowBothCallTypes(
    joinPoint: JoinPoint,
    allowBothCallTypes: AllowBothCallTypes,
  ) {
