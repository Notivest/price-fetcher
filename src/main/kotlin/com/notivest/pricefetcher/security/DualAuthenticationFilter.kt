...
class DualAuthenticationFilter(
  ...
  override fun doFilterInternal(
    ...
    try {
      ...
      if (callContext != null) {
        ...
        logger.debug(
          "Authenticated {} call from: {} with scopes: {} for request: {}",
          if (callContext is GatewayCallContext) "gateway" else "service",
  ...
  private fun determineCallType(request: HttpServletRequest, requestId: String): CallContext? {
  ...
  private fun processGatewayCall(request: HttpServletRequest, requestId: String): GatewayCallContext? {
  ...
  override fun shouldNotFilter(request: HttpServletRequest): Boolean {
    ...
    // No filtrar health checks, actuator y info endpoints
